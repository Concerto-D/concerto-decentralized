...
class MariaDB(Component):
    ...
    def mount(self):
        ...
        #time.sleep(0.8)
        result = call_ansible_on_host(self.host, self.playbook, "mariadb-0", extra_vars={"enos_action":"deploy","db":"mariadb"})
    ...
    def go_ready(self):
        ...
        #time.sleep(5.8)
        result = call_ansible_on_host(self.host, self.playbook, "mariadb-5", extra_vars={"enos_action":"deploy", "db":"mariadb", "db_host":self.host})
