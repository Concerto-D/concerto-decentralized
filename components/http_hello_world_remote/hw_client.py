...
class HW_Client(object):
    ...
    def myrun(self):
        ...
        # RELEASE THE EVENT FOR INDICADING THE END OF THE APP
        self.ev_wait.set() 


    def finish(self):
        print(self.MYCOLOR+"[HW_Client] Waiting end..."+self.RESET)
        print(self.MYCOLOR+"[HW_Client] Going to wait..."+self.RESET)
        self.ev_wait.wait()
        print(self.MYCOLOR+"[HW_Client] Going to wait...done"+self.RESET)
        self.thread.join()
